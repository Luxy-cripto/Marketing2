                ...
                <form action="{{ route('followups.update', $followUp->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="konsumen_id" class="form-select" required>
                            ...
                            @foreach($konsumens as $k)
                                <option value="{{ $k->id }}" {{ $followUp->konsumen_id == $k->id ? 'selected' : '' }}>
                                    {{ $k->nama }}
                                </option>
                            @endforeach
                    ...
                    <div class="mb-3">
                        ...
                        <select name="status" class="form-select">
                            ...
                            <option value="Belum Dihubungi" {{ $followUp->status == 'Belum Dihubungi' ? 'selected' : '' }}>
                                Belum Dihubungi
                            </option>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="catatan" class="form-control" rows="3">{{ $followUp->catatan }}</textarea>
                    </div>
